...
void led_init(void)
{
    ...
    //regwrite32(CTRL + CTRL_CONF_GPMC_A5, 0x27);
    //regwrite32(CTRL + CTRL_CONF_GPMC_A6, 0x27);
    //regwrite32(CTRL + CTRL_CONF_GPMC_A7, 0x27);
    //regwrite32(CTRL + CTRL_CONF_GPMC_A8, 0x27);
...
{
    regwrite32(GPIO1 + GPIO_OE, (pattern & 0xff) << 21);
}
