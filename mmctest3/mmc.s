...
mmc_identify_card_cmd5_done:
    ...
    /* Wait for CMD8 to finish */

mmc_identify_card_wait_for_cmd8:

    ldr base, =mmchs0_base
    ldr tmp, [base, sd_stat]
    tst tmp, sd_stat_cc
    bne mmc_identify_card_cmd8_complete
    tst tmp, sd_stat_erri
    beq mmc_identify_card_wait_for_cmd8
    mov r0, tmp
    bl console_pretty_hexprint
    b .

mmc_identify_card_cmd8_complete:
...
message_done_mmc_init:

    .asciz "Done with mmc_init.\r\n"
