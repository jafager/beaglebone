...
uint32_t mmc_send_command(uint32_t command, uint32_t argument)
{
    ...
    console_puts("command: 0x"); console_print_hexadecimal(command); console_puts("\r\n");
    console_puts("argument: 0x"); console_print_hexadecimal(argument); console_puts("\r\n");
    ...
    if (status & SD_STAT_ERRI)
    {
        ...
        console_puts("cycles: 0x"); console_print_hexadecimal(cycles); console_puts("\r\n");
        console_puts("status: 0x"); console_print_hexadecimal(status); console_puts("\r\n");
        return MMC_ERROR;
    }
